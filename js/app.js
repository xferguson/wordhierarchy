...
!function (e) {
  ...
  var l = function () {
    ...
    }return c(t, React.Component), l(t, [{ key: "componentWillReceiveProps", value: function value(e) {
  ...
  }();u.propTypes = { value: a.default.string, word: a.default.string, children: a.default.node, level: a.default.number, maxLevel: a.default.number, edit: a.default.bool, onRowUpdate: a.default.func, onRowDelete: a.default.func };var s = function (e) {
    function t(e) {
      o(this, t);var n = i(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, e));return n.resetTable = n.resetTable.bind(n), n.newTable = n.newTable.bind(n), n.toggleEdit = n.toggleEdit.bind(n), n.handleAddChildRow = n.handleAddChildRow.bind(n), n.onRowUpdate = n.onRowUpdate.bind(n), n.onRowDelete = n.onRowDelete.bind(n), n.toggleEditTerm = n.toggleEditTerm.bind(n), n.handleEditTerm = n.handleEditTerm.bind(n), n.state = { term: void 0 === e.term ? "Term" : e.term, data: e.data, maxLevel: e.maxLevel, editMode: !1, editTerm: !1 }, n.newRowCounter = 0, n;
    }return c(t, React.Component), l(t, [{ key: "resetTable", value: function value(e) {
        ...
        var e = this,
          ...
          var r = n.word,
              a = n.children;return React.createElement(u, { key: l, value: l, word: r, level: 1, children: a, maxLevel: t, onRowUpdate: e.onRowUpdate, onRowDelete: e.onRowDelete });
  ...
  }();s.propTypes = { term: a.default.string, data: a.default.node, maxLevel: a.default.number };var h, w, m, p;h = r.default, w = "wh-sample", m = "Emotion", p = 3, ReactDOM.render(React.createElement(s, { data: h, term: m, maxLevel: p }), document.getElementById(w));
}, function (e, t, n) {
  e.exports = n(6);
}]);
